...
#define REGULAR 1      //files
#define SPECIAL 2      //Directory
...
{
    int i = 3;    //ufdtarr 0 1 2 reserved
...
int main()
{
    ...
    while(1)    //non-conditional loop
    {
        ...
        if(count == 1)      //Token
        {
            if(strcmp(command[0],"ls") == 0)  //stricmp
            {
                ls_file();
            }
            ...
            {
                system("cls");   //System command terminal kade pass karte
                continue;
            }
            else if(strcmp(command[0],"help") == 0)             //DisplayHelp
            {
                DisplayHelp();
                continue;
            }
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"man") == 0)             // void man
            {
                man(command[1]);
                continue;
            }                                                   
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret >= 0)
                {
                    printf("file is sucessfully created with file discriptor : %d\n",ret);
                }
                if(ret == -1)
                {
                    printf("ERROR : Incorrect parameter\n");
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0)
                {
                    printf("file is sucessfully Opened with file discriptor : %d\n",ret);
                }
                if(ret == -1)
                {
                    printf("ERROR : Incorrect parameter\n");
